function fBIRN_phantom_ABCD(vol4D, meta, output, multiband)

%   This code is adapted from Gary Glover qa.m by Jose Teruel
%   jteruelantolin@ucsd.edu
...
[mean_ghost, top_ghost] = ghosting_metrics(data, NPIX, TR, path, multiband);
...
jsonfile = savejson('Phantom_QC_metrics',data2json,struct('FloatFormat','%.2f'));
...
function [ghostperc, topghostperc] = ghosting_metrics(data, NPIX, TR, path, multiband)
